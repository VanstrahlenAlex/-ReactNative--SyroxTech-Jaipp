...
export default function ProfileScreen() {
	...
	return (
		<ScrollView className="flex-1 bg-black" contentContainerStyle={{ paddingBottom: 24 }}>
			...
			{/* Header simple sin gradiente de fondo */}
			<View className="h-20" />

			{/* Card principal */}
			<View className="bg-black rounded-t-3xl p-6 -mt-8 pt-8">
				<View className="w-full items-center p-6 mt-12">
				...
				<View className="space-y-4 gap-4">
					<TouchableOpacity
						className="flex-row items-center justify-between p-4 bg-black rounded-xl border border-white/30"
						onPress={() => router.push('/(tabs)/account-settings')}
					>
						<View className="flex-row items-center">
							<Feather name="heart" size={22} color="#DB2777" />
							<Text className="ml-4 text-white text-base">Mis suscripciones</Text>
						</View>
					...
					>
						<View className="flex-row items-center">
							<Feather name="dollar-sign" size={22} color="#DB2777" />
					...
					>
						<View className="flex-row items-center">
							<Feather name="credit-card" size={22} color="#DB2777" />
					...
					>
						<View className="flex-row items-center">
							<MaterialCommunityIcons name="help-circle-outline" size={22} color="#DB2777" />
				...
				<TouchableOpacity
					className="flex-row items-center justify-center p-4 rounded-lg mt-8 border border-red-500/70"
					onPress={async () => {
						await signOut();
						router.push('/(auth)');
					}}
